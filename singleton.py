import logging
from .factory import HistoryManagerFactory
...
class HistoryManager(metaclass=SingletonMeta):
    def __init__(self):
        self.facade = HistoryManagerFactory.create_history_manager()
    
    def add_record(self, operation, num1, num2, result):
        return self.facade.add_record(operation, num1, num2, result)
